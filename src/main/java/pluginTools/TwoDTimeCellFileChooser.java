...
public class TwoDTimeCellFileChooser extends JPanel {
	...
	public void DoneCurrCell(Frame parent) throws ImgIOException {
		...
		if(DoMask) {
			...
			InteractiveBud CellCollection = new InteractiveBud(imageOrig, null, imageSegB, imageSegA, new File(impOrig.getOriginalFileInfo().directory), impOrig.getOriginalFileInfo().fileName, calibrationX, calibrationY, calibrationZ,
