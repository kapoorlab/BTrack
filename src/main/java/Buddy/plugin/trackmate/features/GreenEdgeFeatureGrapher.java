...
public class GreenEdgeFeatureGrapher extends GreenAbstractFeatureGrapher {
	...
	public GreenEdgeFeatureGrapher(final String xFeature, final Set<String> yFeatures, final List<DefaultWeightedEdge> edges,
			final GreenModel model) {
		super(xFeature, yFeatures, model);
		this.edges = edges;
		this.xDimension = model.getFeatureModel().getEdgeFeatureGREENDimensions().get(xFeature);
		this.yDimensions = model.getFeatureModel().getEdgeFeatureGREENDimensions();
	...
	public void render() {
		...
		// Check x units
		final String xdim = GreenTMUtils.getUnitsFor(xDimension, model.getSpaceUnits(), model.getTimeUnits());
