 ...
 */
public interface GreenEdgeAnalyzer extends Benchmark, GreenFeatureAnalyzer, MultiThreaded {

	/**
	 * Scores a collection of link between two spots. The results must be stored in
	 * the {@link Buddy.plugin.trackmate.FeatureModel}.
	 * <p>
	 ...
	 */
	public void process(final Collection<DefaultWeightedEdge> edges, GreenModel model);
