...
public class GreenTrackSpeedStatisticsAnalyzer implements GreenTrackAnalyzer {
	...
	static {
		...
		FEATURE_DIMENSIONS.put(TRACK_MEAN_SPEED, GREENDimension.VELOCITY);
		FEATURE_DIMENSIONS.put(TRACK_MAX_SPEED, GREENDimension.VELOCITY);
		FEATURE_DIMENSIONS.put(TRACK_MIN_SPEED, GREENDimension.VELOCITY);
		FEATURE_DIMENSIONS.put(TRACK_MEDIAN_SPEED, GREENDimension.VELOCITY);
		FEATURE_DIMENSIONS.put(TRACK_STD_SPEED, GREENDimension.VELOCITY);
	...
	public GreenTrackSpeedStatisticsAnalyzer() {
		setNumThreads();
	}
				...
				public void run() {
					...
					while ((trackID = queue.poll()) != null) {
						...
						for (final DefaultWeightedEdge edge : track) {
							...
							final double dt = source.diffTo(target, Greenobject.POSITION_T);
