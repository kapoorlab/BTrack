...
public class GreenTrackFeatureGrapher extends GreenAbstractFeatureGrapher {
	...
	public GreenTrackFeatureGrapher(final String xFeature, final Set<String> yFeatures, final GreenModel model) {
		super(xFeature, yFeatures, model);
		this.xDimension = model.getFeatureModel().getTrackFeatureGREENDimensions().get(xFeature);
		this.yDimensions = model.getFeatureModel().getTrackFeatureGREENDimensions();
