 ...
 * BCellobjects which are located at interpolated positions. This is useful if
 * you want to measure signal intensity changing during time, even if the
 * BCellobject is not visible. Thus, trackmate is utilisable for Fluorescence
 * Recovery after Photobleaching (FRAP) analysis.
 *
...
public class CloseGapsByLinearInterpolationAction extends AbstractTMAction {
	...
	public static final ImageIcon ICON = new ImageIcon(
			TrackMateWizard.class.getResource("images/BCellobject_icon.png"));
	...
	public static final String INFO_TEXT = "<html>"
			...
			+ "The BCellobjects positions and size are calculated " + "using linear interpolation." + "</html>";
	...
	private void interpolateFeature(final BCellobject targetBCellobject, final BCellobject BCellobject1,
			final BCellobject BCellobject2, final double weight, final String feature) {
