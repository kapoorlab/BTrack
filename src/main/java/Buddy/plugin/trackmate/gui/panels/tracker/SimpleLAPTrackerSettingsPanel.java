...
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_ALTERNATIVE_LINKING_COST_FACTOR;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_BLOCKING_VALUE;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_CUTOFF_PERCENTILE;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_GAP_CLOSING_FEATURE_PENALTIES;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_LINKING_FEATURE_PENALTIES;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_MERGING_FEATURE_PENALTIES;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_MERGING_MAX_DISTANCE;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_SPLITTING_FEATURE_PENALTIES;
import static Buddy.plugin.trackmate.tracking.TrackerKeys.DEFAULT_SPLITTING_MAX_DISTANCE;
...
public class SimpleLAPTrackerSettingsPanel extends ConfigurationPanel {
	...
	public Map<String, Object> getSettings() {
		...
		settings.put(KEY_GAP_CLOSING_MAX_DISTANCE,
				NumberParser.parseDouble(jTextFieldGapClosingDistanceCutoff.getText()));
		settings.put(KEY_GAP_CLOSING_MAX_FRAME_GAP,
				NumberParser.parseInteger(jTextFieldGapClosingTimeCutoff.getText()));
		// Hop!
		return settings;
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				this.add(jLabelTrackerDescription, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0,
				...
				jLabelTrackerDescription.setText(infoText.replace("<br>", "").replace("<p>", "<p align=\"justify\">")
						.replace("<html>", "<html><p align=\"justify\">"));
			}
			{
				final JLabel jLabel2 = new JLabel();
				this.add(jLabel2, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
			...
			}
			{
				...
				this.add(jLabel3, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
			...
			}
			{
				...
				this.add(jLabel4, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
			...
			}
			{
				...
				this.add(jTextFieldLinkingDistance, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0,
			...
			}
			{
				...
				this.add(jTextFieldGapClosingDistanceCutoff, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			...
			}
			{
				...
				this.add(jTextFieldGapClosingTimeCutoff, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
				jTextFieldGapClosingTimeCutoff.setFont(FONT);
			}
			{
				jLabelLinkingMaxDistanceUnit = new JLabel();
				this.add(jLabelLinkingMaxDistanceUnit, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0,
			...
			}
			{
				...
				this.add(jLabelGapClosingMaxDistanceUnit, new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0,
						GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 10), 0, 0));
			...
			}
			{
				...
				this.add(jLabelGapClosingTimeCutoffUnit, new GridBagConstraints(2, 6, 1, 1, 0.0, 0.0,
						GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 10), 0, 0));
