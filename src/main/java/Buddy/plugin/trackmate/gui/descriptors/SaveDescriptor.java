...
public class SaveDescriptor extends SomeDialogDescriptor {
	...
	public SaveDescriptor(final GreenTrackMateGUIController greencontroller) {
		super(greencontroller.getGUI().getLogPanel());
		this.trackmate = greencontroller.getPlugin();
