...
public class TrackMateGUIController implements ActionListener {
	 ...
	 * {@link Buddy.plugin.trackmate.features.BCellobject.BCellobjectAnalyzerFactory}s
	 * to this GUI.
	 *
	...
	protected FeatureColorGenerator<BCellobject> createBCellobjectColorGeneratorPerTrackFeature() {
		final FeatureColorGenerator<BCellobject> generator = new BCellobjectColorGeneratorPerTrackFeature(
	...
	protected Collection<WizardPanelDescriptor> createDescriptors() {
		 ...
		 */
		configureViewsDescriptor = new ConfigureViewsDescriptor(trackmate, BCellobjectColorGenerator,
				edgeColorGenerator, trackColorGenerator, BCellobjectColorGeneratorPerTrackFeature,
				manualBCellobjectColorGenerator, manualEdgeColorGenerator, this);
