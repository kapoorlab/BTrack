...
public class TimeDirectedSortedDepthFirstIterator extends SortedDepthFirstIterator<BCellobject, DefaultWeightedEdge> {
	...
	public TimeDirectedSortedDepthFirstIterator(final Graph<BCellobject, DefaultWeightedEdge> g,
			final BCellobject startVertex, final Comparator<BCellobject> comparator) {
