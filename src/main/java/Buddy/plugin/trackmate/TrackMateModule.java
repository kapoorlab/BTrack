 ...
 * 
 * This will have a
 * {@link Buddy.plugin.trackmate.features.spot.SpotAnalyzerFactory} module
 ...
 * <ul>
 * <li>{@link Buddy.plugin.trackmate.detection.SpotDetectorFactory}: generates
 * detectors for the detection step of TrackMate.
 * <li>{@link Buddy.plugin.trackmate.features.spot.SpotAnalyzerFactory}:
 * generates analyzers that grant spots with scalar numerical features.
 * <li>{@link Buddy.plugin.trackmate.visualization.ViewFactory}: generates views
 * that can display the detection and tracking results.
 * <li>{@link Buddy.plugin.trackmate.tracking.SpotTrackerFactory}: generates
 * particle linkers for the tracking step of TrackMate.
 * <li>{@link Buddy.plugin.trackmate.features.track.TrackAnalyzer}: compute
 * scalar numerical features for tracks.
 * <li>{@link Buddy.plugin.trackmate.features.edges.EdgeAnalyzer}: compute scalar
 * numerical features for edges (individual links between spots).
 * <li>{@link Buddy.plugin.trackmate.action.TrackMateActionFactory}: generates
