...
import static Buddy.plugin.trackmate.gui.TrackMateWizard.TRACKMATE_ICON;
...
public class IOUtils {
	 ...
	 *            <code>null</code>; in that case, native dialogs will not be used
	 *            on Macs.
	 * @param logger
	...
	public static final boolean writeAttribute(final Map<String, Object> settings, final Element element,
		...
		if (!expectedClass.isInstance(obj)) {
			errorHolder.append("Exoected " + parameterKey + " parameter to be a " + expectedClass.getName()
