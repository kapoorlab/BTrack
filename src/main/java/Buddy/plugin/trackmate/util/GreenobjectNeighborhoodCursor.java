...
public class GreenobjectNeighborhoodCursor<T extends RealType<T>> implements Cursor<T> {
	...
	public GreenobjectNeighborhoodCursor(GreenobjectNeighborhood<T> sn) {
	...
	/**
	 * Return the current inclination with respect to this Greenobject center. Will
	 * be in the range [0, π].
	 * <p>
