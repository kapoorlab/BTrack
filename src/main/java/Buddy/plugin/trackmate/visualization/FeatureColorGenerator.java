...
public interface FeatureColorGenerator<K> extends MinMaxAdjustable {
	 ...
	 * ensures that it gets correctly unregistered and cleaned, should it be a model
	 * listener or have a heavy memory footprint.
	 */
	public void terminate();

	/**
	 * When this color generator is reused, calling this method ensures that it is
	 * registered again, and will follow whatever changes subsequently happening to
	 * the model.
	 */
