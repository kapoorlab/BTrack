...
public interface GreenTrackMateModelView {
	...
	/**
	 * Defines the key for the highlight color, used to paint selection. Accepted
	 * values are color.
	 */
	...
	/**
	 * Defines the key for the Greenobject visibility. Values are boolean. If
	 * <code>false</code>, Greenobjects are not visible.
	 */
	public static final String KEY_GreenobjectS_VISIBLE = "GreenobjectsVisible";
	/**
	 * Defines the key for the Greenobject name display. Values are boolean. If
	 * <code>false</code>, Greenobject names are not visible.
	 */
	public static final String KEY_DISPLAY_Greenobject_NAMES = "DisplayGreenobjectNames";
	/**
	 * Defines the key for the Greenobject radius ratio. Value should be a positive
	 * {@link Double} object. Greenobjects will be rendered with a radius equals to
	...
	/**
	 * Defines the key for the Greenobject coloring method. Accepted values are
	...
	/**
	 * Defines the key for the drawing depth, for views that can use this settings.
	 * The draw depth is the max distance between the view plane and any object for
	 * this object to be drawn. Accepted values are <code>double</code>. The values
	 * must be specified in image units.
	 */
	 ...
	 * <code>true</code>, drawing depth will be limited by the values specified by
	 * {@link #KEY_DRAWING_DEPTH}.
	 */
	...
	/**
	 * Track display mode where the whole tracks are drawn, ignoring the value of
	 * {@link #KEY_TRACK_DISPLAY_DEPTH}.
	 */
	...
	/**
	 * Track display mode similar to {@link #TRACK_DISPLAY_MODE_LOCAL}, except that
	 * for the sake of speed, edges are not faded.
	 */
	 ...
	 */
	public static final String[] TRACK_DISPLAY_MODE_DESCRIPTION = new String[] { "Show all entire tracks",
			"Show local tracks", "Show local tracks, backward", "Show local tracks, forward", "Local tracks (fast)",
			"Local tracks, backward (fast)", "Local tracks, forward (fast)", "Show selection only" };
	...
	/**
	 * The default color for Greenobjects.
	 */
	...
	/**
	 * Removes any overlay (for Greenobjects or tracks) from this displayer.
	 */
	public void clear();

	/**
	 * Centers the view on the given Greenobject.
	 */
	 ...
	 *
	 * @param key
	 *            the key of the parameter to change. the value for the display
	 *            parameter
	 */
