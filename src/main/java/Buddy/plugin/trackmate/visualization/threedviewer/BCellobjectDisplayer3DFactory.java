...
public class BCellobjectDisplayer3DFactory implements ViewFactory {
	...
	public static final String INFO_TEXT = "<html>"
			...
			+ "All the BCellobjects 3D shapes are calculated during the rendering step, which <br>" + "can take long."
			+ "<p>" + "This displayer does not allow manual editing of BCellobjects. Use it only for <br>"
			...
			+ "be in sync with the hyperstack displayer. " + "<p>"
			...
			+ "It contains an immutable snapshot of the model taken at the time when <br>" + "it was launched. "
			+ "</html>";
