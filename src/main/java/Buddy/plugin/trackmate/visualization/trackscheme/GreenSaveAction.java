...
import Buddy.plugin.trackmate.util.DefaultFileFilter;
...
public class GreenSaveAction extends AbstractAction {

	private static final long serialVersionUID = 7672151690754466760L;
	private static final ImageIcon ICON = null; // new
												// ImageIcon(TrackSchemeFrame.class.getResource("resources/camera_export.png"));
	protected String lastDir = null;
	private final GreenTrackScheme trackScheme;

	public GreenSaveAction(GreenTrackScheme trackScheme) {
	 ...
	 * @param frame
	 */
	protected void saveXmlPng(GreenTrackSchemeFrame frame, String filename, Color bg) throws IOException {
