...
public class GreenTrackSchemeGraphComponent extends mxGraphComponent implements mxIEventListener {
	...
	public GreenTrackSchemeGraphComponent(final GreenJGraphXAdapter graph, final GreenTrackScheme trackScheme) {
		super(graph);
	...
	public GreenJGraphXAdapter getGraph() {
		return (GreenJGraphXAdapter) super.getGraph();
	}
					...
					if (null != columnWidths) {
						...
						textArea.addActionListener(new ActionListener() {
							...
							public void actionPerformed(final ActionEvent arg0) {
								...
								GreenTrackSchemeGraphComponent.this.repaint();
							}
						});
