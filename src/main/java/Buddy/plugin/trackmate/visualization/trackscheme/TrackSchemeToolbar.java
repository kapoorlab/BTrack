...
public class TrackSchemeToolbar extends JToolBar {
	...
	private static final ImageIcon LINKING_ON_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
															// "resources/connect.png" ) );
	private static final ImageIcon LINKING_OFF_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
															// "resources/connect_bw.png" ) );
	private static final ImageIcon THUMBNAIL_ON_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
																// "resources/images.png" ) );
	private static final ImageIcon THUMBNAIL_OFF_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
																// "resources/images_bw.png" ) );
	private static final ImageIcon RESET_ZOOM_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
															// "resources/zoom.png" ) );
	private static final ImageIcon ZOOM_IN_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
														// "resources/zoom_in.png" ) );
	private static final ImageIcon ZOOM_OUT_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
															// "resources/zoom_out.png" ) );
	private static final ImageIcon REFRESH_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
														// "resources/refresh.png" ) );
	private static final ImageIcon CAPTURE_UNDECORATED_ICON = null; // new ImageIcon(
																	// TrackSchemeFrame.class.getResource(
																	// "resources/camera_go.png" ) );
	private static final ImageIcon CAPTURE_DECORATED_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
																	// "resources/camera_edit.png" ) );
	private static final ImageIcon DISPLAY_DECORATIONS_ON_ICON = null; // new ImageIcon(
																		// TrackSchemeFrame.class.getResource(
