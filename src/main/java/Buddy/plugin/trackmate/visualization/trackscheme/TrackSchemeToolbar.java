...
public class TrackSchemeToolbar extends JToolBar {
	...
	private static final ImageIcon LINKING_ON_ICON =  new ImageIcon(TrackSchemeFrame.class.getResource(
															 "connect.png" ) );
	private static final ImageIcon LINKING_OFF_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
															 "connect_bw.png" ) );
	private static final ImageIcon THUMBNAIL_ON_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
																 "images.png" ) );
	private static final ImageIcon THUMBNAIL_OFF_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
																 "images_bw.png" ) );
	private static final ImageIcon RESET_ZOOM_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
															 "zoom.png" ) );
	private static final ImageIcon ZOOM_IN_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
														 "zoom_in.png" ) );
	private static final ImageIcon ZOOM_OUT_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
															 "zoom_out.png" ) );
	private static final ImageIcon REFRESH_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
														 "refresh.png" ) );
	private static final ImageIcon CAPTURE_UNDECORATED_ICON =  new ImageIcon(
			TrackSchemeFrame.class.getResource(
																	 "camera_go.png" ) );
	private static final ImageIcon CAPTURE_DECORATED_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
																	 "camera_edit.png" ) );
	private static final ImageIcon DISPLAY_DECORATIONS_ON_ICON =  new ImageIcon(
			TrackSchemeFrame.class.getResource(
																		 "application_view_columns.png" ) );
	private static final ImageIcon SELECT_STYLE_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
															"theme.png" ) );
