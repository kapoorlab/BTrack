...
public class mxSideTextShape extends mxDefaultTextShape {
	...
	@Override
	public void paintShape(final mxGraphics2DCanvas canvas, final String text, final mxCellState state,
		...
		if (g.getClipBounds() == null || g.getClipBounds().intersects(rect)) {
			...
			final Object vertAlign = mxUtils.getString(style, mxConstants.STYLE_VERTICAL_ALIGN,
