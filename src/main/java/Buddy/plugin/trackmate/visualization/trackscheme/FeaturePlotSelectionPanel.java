...
public class FeaturePlotSelectionPanel extends ActionListenablePanel {
	...
	private static final ImageIcon PLOT_ICON = new ImageIcon( TrackSchemeFrame.class.getResource(
														 "plots.png" ) );

	private static final ImageIcon ADD_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
													 "add.png" ) );

	private static final ImageIcon REMOVE_ICON =  new ImageIcon( TrackSchemeFrame.class.getResource(
														"delete.png" ) );
