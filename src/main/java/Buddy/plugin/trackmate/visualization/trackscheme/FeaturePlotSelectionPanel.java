...
public class FeaturePlotSelectionPanel extends ActionListenablePanel {
	...
	private static final ImageIcon PLOT_ICON = null; // new ImageIcon( TrackSchemeFrame.class.getResource(
														// "resources/plots.png" ) );

	private static final ImageIcon ADD_ICON = null;// new ImageIcon( FeaturePlotSelectionPanel.class.getResource(
													// "resources/add.png" ) );

	private static final ImageIcon REMOVE_ICON = null;// new ImageIcon( FeaturePlotSelectionPanel.class.getResource(
	...
	public FeaturePlotSelectionPanel(final String xKey, final List<String> features,
