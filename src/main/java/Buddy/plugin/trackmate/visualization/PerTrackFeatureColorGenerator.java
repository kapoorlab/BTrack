...
import static Buddy.plugin.trackmate.visualization.TrackMateModelView.DEFAULT_TRACK_COLOR;
...
public class PerTrackFeatureColorGenerator implements TrackColorGenerator, ModelChangeListener {
	 ...
	 * values to be accurate. We rely on the model instance for that. Then colors
	 * are calculated for all tracks when this method is called, and cached.
	 *
	 * @param feature
	...
	/**
	 * Returns the color currently associated to the track with the specified ID.
	 *
	 * @param trackID
	 *            the ID of the track.
	 * @return a color.
