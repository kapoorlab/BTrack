...
public class TrackOverlay extends Roi {
	...
	private static final boolean isOnClip(final BCellobject source, final BCellobject target, final double minx,
	...
	protected void drawEdge(final Graphics2D g2d, final BCellobject source, final BCellobject target, final int xcorner,
