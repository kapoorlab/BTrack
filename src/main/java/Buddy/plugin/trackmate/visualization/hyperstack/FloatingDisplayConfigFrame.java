...
public class FloatingDisplayConfigFrame extends JFrame {
	...
	protected PerTrackFeatureColorGenerator createTrackColorGenerator() {
		final PerTrackFeatureColorGenerator generator = new PerTrackFeatureColorGenerator(model,
	...
	protected FeatureColorGenerator<BCellobject> createBCellobjectColorGeneratorPerTrackFeature() {
		final FeatureColorGenerator<BCellobject> generator = new BCellobjectColorGeneratorPerTrackFeature(model,
				TrackIndexAnalyzer.TRACK_INDEX);
		return generator;
	}
