...
public class CVMKalmanFilter {
	 ...
	 * 
	 * @param X0
	 *            initial state estimate. Must a 6 elements <code>double[]</code>
	 *            array with <code>x0, y0, z0, vx0, vy0, vz0</code> with velocity in
	 *            <code>length/frame</code> units.
	 * @param initStateCovariance
	 *            the initial state covariance. Give it a large value if you do not
	 *            trust the initial state estimate (<i>e.g.</i> 100), a small value
	 *            otherwise (<i>e.g.</i>1e-2).
	 * @param positionProcessStd
	 *            the std of the additive white gaussian noise affecting the
	 *            <b>position</b> evolution. Large values means that the position
	 *            undergoes heavy fluctuations.
	 * @param velocityProcessStd
	 *            the std of the additive white gaussian noise affecting the
	 *            <b>velocity</b> evolution. Careful, we expect it to be in units of
	 *            <code>length/frame</code>. Large values means that the velocity
	 *            undergoes heavy fluctuations.
	 * @param positionMeasurementStd
	 *            the std of the additive white gaussian noise affecting the
	 *            position <b>measurement</b>. Large values means that the positions
	 *            measured are not accurate.
	 */
