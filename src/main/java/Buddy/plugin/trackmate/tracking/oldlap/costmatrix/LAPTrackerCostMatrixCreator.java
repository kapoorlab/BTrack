 ...
 */
public abstract class LAPTrackerCostMatrixCreator extends MultiThreadedBenchmarkAlgorithm
	...
	/**
	 * Takes the submatrix of costs defined by rows 0 to numRows - 1 and columns 0
	 * to numCols - 1, transpose it, and sets any non-BLOCKED value to be cutoff.
	 * <p>
	...
	/**
	 * Sets alternative scores in a new matrix along a diagonal. The new matrix is n
	 * x n, and is set to BLOCKED everywhere except along the diagonal that runs
