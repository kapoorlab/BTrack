...
public class SparseCostMatrix {
	 ...
	 *             if the cost and column arrays are not of the same size, if the
	 *             column array is not sorted row by row, of if one row has 0
	 *             non-infinite costs.
	 */
	 ...
	 *            the column.
	 * @param missingValue
	 *            what to return if the sparse matrix does not store a value at the
