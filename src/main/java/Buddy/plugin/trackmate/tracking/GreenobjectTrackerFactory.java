...
public interface GreenobjectTrackerFactory extends TrackMateModule {
	...
	/**
	 * Instantiates and returns a new {@link GreenobjectTracker} configured to
	 * operate on the specified {@link GreenobjectCollection}, using the specified
	 * settins map.
	 *
	 * @param Greenobjects
	 *            the {@link GreenobjectCollection} containing the Greenobjects to
	 *            track.
	 * @param settings
