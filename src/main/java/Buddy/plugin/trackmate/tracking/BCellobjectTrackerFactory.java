...
public interface BCellobjectTrackerFactory extends TrackMateModule {
	...
	/**
	 * Instantiates and returns a new {@link BCellobjectTracker} configured to
	 * operate on the specified {@link BCellobjectCollection}, using the specified
	 * settins map.
	 *
	 * @param BCellobjects
	 *            the {@link BCellobjectCollection} containing the BCellobjects to
	 *            track.
	 * @param settings
