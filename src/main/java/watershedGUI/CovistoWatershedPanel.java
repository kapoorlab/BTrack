...
public class CovistoWatershedPanel {
	...
	public static JScrollBar thresholdWaterslider = new JScrollBar(Scrollbar.HORIZONTAL, thresholdsliderWaterInit, 10,
			0, 10 + scrollbarSize);
	...
	public void setInitialThresholdWater(final float value) {
		...
		thresholdInitWater = scrollbar.Utility.computeScrollbarPositionFromValue(thresholdWater, thresholdMinWater,
				thresholdMaxWater, scrollbarSize);
	}
	...
	public static JPanel WaterPanel() {
		...
		Border waterborder = new CompoundBorder(new TitledBorder("Watershed detection"),
