...
/**
 * A {@link RealLocalizable} implementation, used in bTrackMate to represent a filament
 * detection.
 * <p>
...
public class ExtendedSpot extends AbstractEuclideanSpace implements RealLocalizable, Comparable< ExtendedSpot >
{
	 ...
	 * @param xx
	 *            the spot covariance XX coordinates, in image units.
	 * @param yy
	 *            the spot covariance YY coordinates, in image units.
	 * @param zz
	 *            the spot covariance ZZ coordinates, in image units.
	 * @param xy
	 *            the spot covariance XY coordinates, in image units.
	 * @param xz
	 *            the spot covariance XZ coordinates, in image units. 
	 * @param yz
	 *            the spot covariance YZ coordinates, in image units.          
	 ...
	 *            the spot name.
	 */
	public ExtendedSpot( final double x, final double y, final double z, final double xx, final double yy, final double zz,
			final double xy, final double xz, final double yz,
	 ...
	 *            the spot quality.
	 */
	public ExtendedSpot( final double x, final double y, final double z,
			final double xx, final double yy, final double zz,
			final double xy, final double xz, final double yz,
	 ...
	 *
	 * @param location
	 *            the {@link RealLocalizable} that contains the spot location.
	 * @param covariance
	 *            the {@link RealLocalizable} that contains the spot covariance.
	 * @param radius
	 *            the spot radius, in image units.
	 * @param quality
	 *            the spot quality.
	 ...
	 *            the spot name.
	 */
	public ExtendedSpot( final RealLocalizable location, final RealLocalizable covariance, final double radius, final double quality, final String name )
	{
	 ...
	 *            the spot quality.
	 */
	public ExtendedSpot( final RealLocalizable location,final RealLocalizable covariance, final double radius, final double quality )
	{
	...
	{
		this( spot.getFeature(POSITION_X),spot.getFeature(POSITION_Y), spot.getFeature(POSITION_Z), spot.getFeature(COV_XX),spot.getFeature(COV_YY),spot.getFeature(COV_ZZ),
				spot.getFeature(COV_XY),spot.getFeature(COV_XZ),spot.getFeature(COV_YZ),
				spot.getFeature( RADIUS ), spot.getFeature( QUALITY ), spot.getName() );
	}
