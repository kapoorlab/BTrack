...
public class LabelImageDetector<T extends RealType<T> & NativeType<T>> implements SpotDetector<T> {
	...
	public LabelImageDetector(final RandomAccessible<T> input, final Interval interval, final double[] calibration,
	...
	public boolean process() {
		...
		LoopBuilder.setImages(Views.zeroMin(rai), img).multiThreaded()
