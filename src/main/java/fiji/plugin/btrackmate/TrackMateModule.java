 ...
 * 
 * This will have a
 * {@link fiji.plugin.btrackmate.features.spot.SpotAnalyzerFactory} module
 ...
 * <ul>
 * <li>{@link fiji.plugin.btrackmate.detection.SpotDetectorFactory}: generates
 * detectors for the detection step of TrackMate.
 * <li>{@link fiji.plugin.btrackmate.features.spot.SpotAnalyzerFactory}:
 * generates analyzers that grant spots with scalar numerical features.
 * <li>{@link fiji.plugin.btrackmate.visualization.ViewFactory}: generates views
 * that can display the detection and tracking results.
 * <li>{@link fiji.plugin.btrackmate.tracking.SpotTrackerFactory}: generates
