...
import Buddy.plugin.trackmate.providers.SpotAnalyzerProvider;
...
public class TrackMateRunner_ extends TrackMatePlugIn_ {
	 ...
	 * Spots in tracks. If used, tracks made of less Spots than the
	...
	private Map<String, FilterGenerator> prepareTrackFiltersParsableArguments() {
		...
		// Filter on NSpots.
		final FilterGenerator nSpotsFilter = new FilterAboveGenerator(
