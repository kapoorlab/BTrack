...
/**
 * Mother interface for {@link BCellobjectDetector} factories.
 * <p>
 * These classes are able to configure a {@link BCellobjectDetector} to operate on a
 ...
 */
public interface BCellobjectDetectorFactory< T extends RealType< T > & NativeType< T >> extends TrackMateModule
{

	/**
	 * Returns a new {@link BCellobjectDetector} configured to operate on the given
	 ...
	 */
	public BCellobjectDetector< T > getDetector( final Interval interval, int frame );
	 ...
	 * @see BCellobjectDetectorFactory#getErrorMessage()
	 */
	 ...
	 * {@link BCellobjectDetectorFactory} key.
	 *
