 ...
 */
public class GREENSortedDepthFirstIterator< V, E > extends AbstractGraphIterator< V, E >
{
	 ...
	 */
	public GREENSortedDepthFirstIterator( final Graph< V, E > g, final V startVertex, final Comparator< V > comparator )
	{
		super(g);
