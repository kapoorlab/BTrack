...
public class TimeDirectedSortedDepthFirstIterator extends SortedDepthFirstIterator<Budpointobject, DefaultWeightedEdge> {

	public TimeDirectedSortedDepthFirstIterator(final Graph<Budpointobject, DefaultWeightedEdge> g, final Budpointobject startVertex, final Comparator<Budpointobject> comparator) {
