...
public class BUDDYBudTimeDirectedSortedDepthFirstIterator
		extends BUDDYSortedDepthFirstIterator<Budobject, DefaultWeightedEdge> {

	public BUDDYBudTimeDirectedSortedDepthFirstIterator(final Graph<Budobject, DefaultWeightedEdge> g,
			final Budobject startVertex, final Comparator<Budobject> comparator) {
