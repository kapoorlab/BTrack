...
public class BUDDYTimeDirectedDepthFirstIterator
		extends BUDDYSortedDepthFirstIterator<Budpointobject, DefaultWeightedEdge> {

	public BUDDYTimeDirectedDepthFirstIterator(Graph<Budpointobject, DefaultWeightedEdge> g,
			Budpointobject startVertex) {
