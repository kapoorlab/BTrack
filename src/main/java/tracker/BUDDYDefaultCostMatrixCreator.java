 ...
 * @param <K>
 */
public class BUDDYDefaultCostMatrixCreator<K extends Comparable<K>, J extends Comparable<J>>
	...
	public BUDDYDefaultCostMatrixCreator(final List<K> rows, final List<J> cols, final double[] costs,
