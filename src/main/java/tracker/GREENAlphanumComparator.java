...
public class GREENAlphanumComparator implements Comparator<String>
	{
		public static final GREENAlphanumComparator instance = new GREENAlphanumComparator();
	    ...
	    // Singleton
	    private GREENAlphanumComparator() {}
