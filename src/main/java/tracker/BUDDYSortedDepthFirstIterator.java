 ...
 */
public class BUDDYSortedDepthFirstIterator<V, E> extends AbstractGraphIterator<V, E> {
	 ...
	 */
	public BUDDYSortedDepthFirstIterator(final Graph<V, E> g, final V startVertex, final Comparator<V> comparator) {
		super(g);
