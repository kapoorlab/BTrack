...
public class Distance {
	...
	public static double DistanceSq(final double[] pointA, final double[] pointB) {
		...
		for (int d = 0; d < numDim; ++d) {
			...
			distance += (pointA[d] - pointB[d]) * (pointA[d] - pointB[d]);
	...
	public static double DistanceSqrt(final RealLocalizable pointA, final RealLocalizable pointB) {
		...
		for (int d = 0; d < numDim; ++d) {
			...
			distance += (pointAA[d] - pointBB[d]) * (pointAA[d] - pointBB[d]);
	...
	public static double AngleVectors(final RealLocalizable pointA, final RealLocalizable pointB,
			final RealLocalizable midpoint) {
	...
	public static double SignDistance(RealLocalizable cordA, RealLocalizable cordB) {
		...
		distance = Math.signum((cordA.getDoublePosition(1) - cordB.getDoublePosition(1))
				/ (cordA.getDoublePosition(0) - cordB.getDoublePosition(0)));
